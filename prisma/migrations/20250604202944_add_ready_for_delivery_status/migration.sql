...
-- CreateEnum
CREATE TYPE "ServiceStatus" AS ENUM ('PENDING_PICKUP', 'ASSIGNED_TO_ROUTE', 'PICKED_UP', 'LABELED', 'IN_PROCESS', 'READY_FOR_DELIVERY', 'PARTIAL_DELIVERY', 'COMPLETED', 'CANCELLED');
